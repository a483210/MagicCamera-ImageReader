...
import com.seu.magicfilter.encoder.video.ImageEncoderCore.OnImageEncoderListener;
...
public class MagicCameraView extends MagicBaseView {
            ...
            switch (recordingStatus) {
                case RECORDING_OFF:
                    ...
                    videoEncoder.startRecording(new TextureMovieEncoder.EncoderConfig(
                            outputFile, CameraEngine.RECORD_WIDTH / 2, CameraEngine.RECORD_HEIGHT / 2,
    ...
    public void setOnImageEncoderListener(OnImageEncoderListener l) {
        videoEncoder.setOnImageEncoderListener(l);//其实我这样写会造成内存泄漏，如果你要移植，videoEncoder不要做静态变量
    }
